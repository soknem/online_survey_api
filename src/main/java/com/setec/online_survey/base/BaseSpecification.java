...
public class BaseSpecification<T> {
    ...
    private Predicate createNotEqualPredicate(From<?, ?> from, CriteriaBuilder criteriaBuilder, SpecsDto specs, Class<?> fieldType) {
    ...
    private Predicate createNotLikePredicate(From<?, ?> from, CriteriaBuilder criteriaBuilder, SpecsDto specs,  qClass<?> fieldType) {
